...
<div class="section-wrapper">
    <div class="section-header-inline">
        <h2><i class="bi bi-clipboard2-pulse-fill"></i> Menu Utama Dokter</h2>
    ...
    <div class="cards-grid">
        ...
        <div class="data-card">
            ...
            <h4>Profil Saya</h4>
            <p class="card-label">Informasi akun & identitas dokter</p>
            <a href="{{ route('dokter.profil.index') }}" class="card-link">
                <i class="bi bi-arrow-right-circle-fill"></i>
            </a>
        </div>
