...
<div class="card-custom">
    <div class="card-header-custom">
        <h5 class="card-title-custom">
            <i class="bi bi-collection"></i> Data Kode Tindakan Terapi
        </h5>
...
<div class="row mt-4">
    <div class="col-md-6 mb-3">
        <div class="stats-card-custom">
            <div>
                <p class="text-muted mb-1" style="font-size:13px;font-weight:600;">Total Kode</p>
    ...
    <div class="col-md-6 mb-3">
        <div class="stats-card-custom recent">
            <div>
                ...
                <h6 class="mb-0">{{ $kodeTindakanTerapi->last()->kode ?? '-' }}</h6>
            </div>
