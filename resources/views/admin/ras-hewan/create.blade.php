...
<div class="form-container-custom">
    <div class="page-header-custom">
        <h1 class="page-title-custom">Tambah Ras Hewan</h1>
        <p class="page-subtitle-custom">Buat ras baru di sistem</p>
    </div>

    <div class="card-custom">
        <div class="card-header-custom create-header">
            <h5 class="card-title-custom">
                <i class="bi bi-plus-circle"></i> Form Tambah Ras
            </h5>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.ras-hewan.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    @enderror
                    <small class="form-help-text">Masukkan nama ras yang sesuai dengan fungsi dalam sistem</small>
                </div>
                ...
                <div class="form-actions-custom">
                    <button type="submit" class="btn-success-custom">
                        <i class="bi bi-save"></i> Simpan Ras Hewan
                    </button>
