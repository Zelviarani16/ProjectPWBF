<div class="sidebar">
    ...
    <div class="user-profile">
        ...
        <div class="user-info">
            ...
            <span class="user-role">Dokter</span>
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('dokter.rekam-medis.index') }}" 
                class="menu-item {{ request()->routeIs('dokter.rekam-medis.*') ? 'active' : '' }}">
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('dokter.profil.index') }}" 
                class="menu-item {{ request()->routeIs('dokter.profil.index') ? 'active' : '' }}">
