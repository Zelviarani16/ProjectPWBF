<div class="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu-section">
            <div class="menu-title">
                <i class="bi bi-paw"></i> Hewan Peliharaan
            </div>

            <a href="{{ route('pemilik.hewan') }}" 
                class="menu-item {{ request()->routeIs('pemilik.hewan') ? 'active' : '' }}">
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('pemilik.jadwal-temu-dokter') }}" 
                class="menu-item {{ request()->routeIs('pemilik.jadwal-temu-dokter') ? 'active' : '' }}">
